...
genome_path = f"data/carpediemonas_membranifera.fasta"
# output gtf file
...
pred = pred_gtf.get_predictions(x_seq, hmm_filter=False)

# infer gene structures and write GTF file
anno, tx_id = pred_gtf.create_gtf(y_label=pred, coords=coords,
